...
Current bugs: Again, none, as far as I am aware. A user-level "bug" is that each board requires the proper knowledge of how its tag system works, i.e. if a user wishes to find images of Rarity, the My Little Pony character, on e621.net, they must search "Rarity_(mlp)". 
...
At this time, because of how lxml.html functions or how the FimFiction.net pages are written, the module cannot retrieve the word count, categories, or views. 
